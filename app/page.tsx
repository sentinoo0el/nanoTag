...
const DiscordJoinPopup = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in-0 duration-300">
      <div className="bg-slate-800 border border-indigo-500/50 rounded-2xl p-8 max-w-lg mx-4 shadow-2xl animate-in zoom-in-95 slide-in-from-bottom-4 duration-500">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
        ...
        <div className="text-center space-y-6">
          ...
          <div className="relative rounded-xl overflow-hidden border border-indigo-500/30">
            <img src="/discord-invite.png" alt="Discord Server Preview" className="w-full h-48 object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent" />
            <div className="absolute bottom-4 left-4 right-4">
              <div className="flex items-center gap-2 text-indigo-400 mb-1">
                <Users className="h-4 w-4" />
                <span className="font-semibold text-sm">nanochecker Community</span>
              </div>
              <p className="text-white text-sm font-medium">Connect with other users and get support!</p>
            </div>
          </div>
